...
function saveTranslation() {
  ...
  setInnerText(e, n);
  var xp = (p == "" ? p : p + "/");
  putRest("https://tanda.telegate.net.au/rest/system/dict/" + session.lang + "/" + xp + t, n);
}
...
function loadLang(file) {
  ...
  var n = getRest("https://tanda.telegate.net.au/rest/system/translation/" + session.lang + "/" + f);
  for (var i in n) {
    translations[i] = n[i];
  }
}
